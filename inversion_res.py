...
for epoch in range(n_epochs):
    ...
    for i, year in enumerate(years):
        ...
        d_loss += alpha_res*loss_res
        loss += alpha_res*loss_res + alpha_reg*reg
...
# save data
sio.savemat('data/m_inv_res.mat',
...
sio.savemat('data/training_history_res.mat', mdict={'total_loss': np.array(total_loss),
                                                'data_loss': np.array(data_loss)})
torch.save(model.state_dict(), 'saved_models/model_res.pth')
