...
for epoch in range(n_epochs):
    ...
    for i, year in enumerate(years):
        ...
        d_loss += alpha_seis*loss_seis
        loss += alpha_seis*loss_seis + alpha_reg*reg
...
# save data
sio.savemat('data/m_inv_seis.mat',
...
sio.savemat('data/training_history_seis.mat', mdict={'total_loss': np.array(total_loss),
                                                'data_loss': np.array(data_loss)})
torch.save(model.state_dict(), 'saved_models/model_seis.pth')
